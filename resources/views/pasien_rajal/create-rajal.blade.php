                ...
                <div class="card-body">
                    <form action="{{ route ('pasien_rajal.simpan')}}" method="POST" onsubmit="return validateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="Nama_Pasien" name="Nama_Pasien" class="form-control @error ('Nama_Pasien') is-invalid @enderror"
                                placeholder="Nama Pasien"  required autofocus></input>
