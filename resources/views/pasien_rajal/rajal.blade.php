    ...
    <section class="home">
        ...
        <div class="content">
            ...
            <div class="card card-info card-outline">
                ...
                <div class="cetak">
                    <div class="cetak pdf">
                        <a href="/cetak-rajal" class="btn btn-success print-btn"> Cetak <i class="fas fa-plus-square"></i></a>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="btn btn-outline-light btn-sm hapus-btn" data-id="{{ $item->NIK }}" data-nama="{{ $item->NIK }}" data-bs-toggle="modal" data-bs-target="#modalHapus-{{ $item->NIK }}"> <i class='bx bx-trash'></i></a>
                                </td>
                            </tr>
                        </tbody>
                        @endforeach
